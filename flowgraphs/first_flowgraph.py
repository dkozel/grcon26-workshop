...
# Description: Signal Source -> Throttle -> time and frequency displays
...
class first_flowgraph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "first_flowgraph")
        ...
        self._freq_range = qtgui.Range(0, 16000, 100, 1000, 200)
        self._freq_win = qtgui.RangeWidget(self._freq_range, self.set_freq, "Frequency (Hz)", "counter_slider", float, QtCore.Qt.Horizontal)
